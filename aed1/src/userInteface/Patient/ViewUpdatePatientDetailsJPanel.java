...
public class ViewUpdatePatientDetailsJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        patientIDJLabel.setForeground(new java.awt.Color(0, 0, 255));
        patientIDJLabel.setText("Patient ID");

        primaryDocNameJLabel.setForeground(new java.awt.Color(0, 0, 255));
        primaryDocNameJLabel.setText("Primary Doctor Name");

        prefferedPharmacyJLabel.setForeground(new java.awt.Color(0, 0, 255));
