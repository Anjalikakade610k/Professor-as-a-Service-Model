...
public class CreatePatientJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        patientIDJLabel.setForeground(new java.awt.Color(0, 51, 255));
        patientIDJLabel.setText("Patient ID");

        primaryDocNameJLabel.setForeground(new java.awt.Color(0, 51, 255));
        primaryDocNameJLabel.setText("Primary Doctor Name");

        prefferedPharmacyJLabel.setForeground(new java.awt.Color(0, 51, 255));
